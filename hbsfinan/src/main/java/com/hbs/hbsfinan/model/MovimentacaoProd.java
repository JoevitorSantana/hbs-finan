...
public class MovimentacaoProd {
    ...
    public MovimentacaoProd(Produtos produto, Funcionario funcionario, long quantidadeMovimentada, TipoMovimentacao tipo, String observacao) {
        this();
