...
public class UsuarioRepository implements IUsuarioRepository {
    ...
    public void save(Usuario usuario) {
        dbConn.update("INSERT INTO usuario (nome, ultimo_nome, email, senha, role) VALUES (?,?,?,?,?)", usuario.getNome(), usuario.getUltimoNome(), usuario.getEmail(), usuario.getSenha(), usuario.getRole().getRole().toUpperCase());
    }
